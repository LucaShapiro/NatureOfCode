class Ant {
  ...
  void display() {
    ...
    vertex(-(ellipse1.x/2 + ellipse2.x + ellipse3.x +
      ellipse3.x/2)+3*overlap-10, -10);
    vertex(-(ellipse1.x/2 + ellipse2.x + ellipse3.x +
      ellipse3.x/2)+3*overlap-20, -12);
    endShape();
    ...
    vertex(-(ellipse1.x/2 + ellipse2.x + ellipse3.x/2)+2*overlap-8, -10);
    vertex(-(ellipse1.x/2 + ellipse2.x + ellipse3.x/2)+2*overlap-18, -15);
    endShape();
    ...
    beginShape();
    vertex(-(ellipse1.x/2 + ellipse2.x + ellipse3.x/2)+2*overlap, 0);
    vertex(-(ellipse1.x/2 + ellipse2.x + ellipse3.x/2)+2*overlap+1, -10);
    vertex(-(ellipse1.x/2 + ellipse2.x + ellipse3.x/2)+2*overlap+6, -20);
    endShape();
    ...
    vertex(-(ellipse1.x/2 + ellipse2.x/2)+2, -10);
    vertex(-(ellipse1.x/2 + ellipse2.x/2)+15, -23);
    endShape();
